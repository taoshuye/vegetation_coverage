...
def vegetation_coverage(photo):
    try:
        ...
        cv2.imshow('photo_otus1', photo_otus)
        cv2.imwrite('photo_otus1.jpg', photo_otus)
        # cv2.waitKey
        ...
        cv2.imshow('photo_color1', photo_color)
        cv2.imwrite('photo_color1.jpg', photo_color)
        # cv2.waitKey()
...
vegetation_coverage("E:\\python\\opencv\\6.jpg")
